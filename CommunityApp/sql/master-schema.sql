...
CREATE TABLE IF NOT EXISTS `community_master` (
  `COMMUNITY_ID` int(10) NOT NULL,
  `COMMUNITY_ADDRESS_MAIN` varchar(255) DEFAULT NULL,
...
-- Dumping structure for table smart_nehiborhood.community_vendor_type
CREATE TABLE IF NOT EXISTS `community_vendor_type` (
  `COMMUNITY_VENDOR_TYPE_ID` int(10) NOT NULL,
  `COMMUNITY_ID` int(10) NOT NULL,
  `COMMUNITY_VENDOR_TYPE_NAME` varchar(20) NOT NULL,
  PRIMARY KEY (`COMMUNITY_VENDOR_TYPE_ID`),
  KEY `fk_COMMUNITY_VENDOR_TYPE_COMMUNITY_MASTER1` (`COMMUNITY_ID`),
  CONSTRAINT `fk_COMMUNITY_VENDOR_TYPE_COMMUNITY_MASTER1` FOREIGN KEY (`COMMUNITY_ID`) REFERENCES `community_master` (`COMMUNITY_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
