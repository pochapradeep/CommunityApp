...
CREATE TABLE IF NOT EXISTS `COMMUNITY_PENDING_REGISTRATION` (
  ...
  RESIDENCE_UNIT_ID INT(10) NULL,
  `FIRST_NAME` VARCHAR(50) NULL,
  `LAST_NAME` VARCHAR(50) DEFAULT NULL,
  `CONFIRMATION_CODE` INT(5) NULL,
  ...
  CONSTRAINT FK_COMMUNITY_PENDING_REGISTRATION_RESDIDENCE_UNIT_ID1 FOREIGN KEY (`RESIDENCE_UNIT_ID`) REFERENCES `RESIDENCE_UNIT` (`RESIDENCE_UNIT_ID`),
...
CREATE TABLE IF NOT EXISTS `resident_proof` (
  ...
  CONSTRAINT `fk_RESIDENT_PROOF_COMMUNITY_PENDING_REGISTRATION_ID1` FOREIGN KEY (`COMMUNITY_PENDING_REGISTRATION_ID`) REFERENCES `COMMUNITY_PENDING_REGISTRATION` (`COMMUNITY_PENDING_REGISTRATION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
